...
```{r ans14}
# TpeJason
texttime <- ymd_hm("2020-10-06 21:00",
                   tz="America/New_York")
TpeJason <-with_tz(texttime, tzone = "Asia/Taipei")
print(TpeJason)
```
...
chNumbers<-as.numeric(chNumbers)
sum(chNumbers)
```
...
```{r ans22}
# sumChNumbersWith0
chNumbersWith0<-as.numeric(chNumbersWith0)
sum(chNumbersWith0)
```
...
```{r ans32}
# dearStudent
studentnt<-c("Dear",student$name,":","貼心提醒您，作業上傳截止時間是",student$deadline,"。","敬祝學安","你的貼心學伴巴西利bot silly")
dearStudent<-paste0(studentnt[[1]],studentnt[[2]],studentnt[[3]],studentnt[[4]],studentnt[[5]],studentnt[[6]],studentnt[[7]],studentnt[[8]])
print(dearStudent)
```
