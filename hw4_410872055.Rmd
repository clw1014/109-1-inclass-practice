...
ntpulogo=ntpuLogoRaster
ntpulogo[c(1:183),1]<-"red"
ntpulogo[c(1:183),300]<-"red"
ntpulogo[1,c(1:300)]<-"red"
ntpulogo[183,c(1:300)]<-"red"
ntpuLogoRaster_redFrame=ntpulogo
```
...
ntpugrey=ntpuLogoRaster
ntpugrey[c(105:145),c(55:95)]<-"grey"
ntpuLogoRaster_greySelect=ntpugrey
```
...
```{r ans43me}
whichIsTransparent=str_which(ntpuLogoRaster,"transparent")
ntpuLogoRaster_blue <- ntpuLogoRaster
{
whichIsNotTransparent=-c(whichIsTransparent)
}
