...
recommend1<-list(
  ...
  price=list("中碗"=159,"超值碗"=179,"超大碗"=199,"迷你碗"=149,"MEGA碗"=239
  )
)
```
...
sukiyaMenu3<-list(
  ...
  price=c(109,c("中碗"=159,"超值碗"=179,"超大碗"=199,"迷你碗"=149,"MEGA碗"=239))
)
```
...
```{r ans22}
# totalAmount
t<-sukiyaMenu[[7]][[1]][[10]][[2]]
ta<-sukiyaMenu[[8]][[2]][[10]][[1]]
totalAmount<-t$price+ta$price
```
